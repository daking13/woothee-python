...
CATEGORY_PC = 'desktop'
CATEGORY_SMARTPHONE = 'mobile'
CATEGORY_MOBILEPHONE = 'mobile'
...
def _init():
    ...
    obj['vendor'] = 'Google'
    DATASET[obj['label']] = obj
    obj = {'label': 'Weibo', 'name': 'Weibo App', 'type': 'browser'}  # NOQA
    obj['vendor'] = 'Weibo'
    DATASET[obj['label']] = obj
    obj = {'label': 'AppleNews', 'name': 'AppleNews App', 'type': 'browser'}  # NOQA
    obj['vendor'] = 'AppleNews'
    DATASET[obj['label']] = obj
    obj = {'label': 'dealmoon', 'name': 'Dealmoon App', 'type': 'browser'}  # NOQA
    obj['vendor'] = 'Dealmoon'
    DATASET[obj['label']] = obj
    obj = {'label': 'WeChat', 'name': 'WeChat App', 'type': 'browser'}  # NOQA
    obj['vendor'] = 'WeChat'
    DATASET[obj['label']] = obj
    ...
    obj['category'] = 'mobile'
    DATASET[obj['label']] = obj
    obj = {'label': 'AndroidTablet', 'name': 'Android', 'type': 'os'}  # NOQA
    obj['category'] = 'tablet'
    DATASET[obj['label']] = obj
